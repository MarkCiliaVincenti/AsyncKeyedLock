...
/// </summary>
public class PooledTestsForAsyncKeyedLock
{
    private static readonly AsyncKeyedLocker<string> _asyncKeyedLocker = new AsyncKeyedLocker<string>(o => { o.PoolSize = 20; o.PoolInitialFill = 1; });
